...
class WeatherStationSystem:
    ...
    def init_sensor_config(self):
        ...
        self.sensor_configs = {
            ...
            "wind_speed": {
                "parser": lambda data: data.get("wind_speed", 0.0)
                * 3.6,  # Convert to km/h, default to 0.0
                "display_format": lambda v: f"{v:.1f}",
            ...
            "aqi": {
                "parser": lambda data: (
                    self.calculate_aqi(data.get("pm2_5")) if data.get("pm2_5") else None
                ),
    ...
    def update_state_displays(self):
        ...
        # AQI state
        aqi = (
            self.calculate_aqi(self.sensor_data.get("pm2_5"))
            if self.sensor_data.get("pm2_5")
            else None
        )
